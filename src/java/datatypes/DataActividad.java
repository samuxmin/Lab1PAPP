...
public class DataActividad {
    ...
    public DataActividad(String[] salidasTur, Departamento departamento, String proveedor, String nombre, String descripcion, int duracionHoras, double costoPorTurista, String ciudad, LocalDate fechaAlta, String imagen, String urlVideo) {
