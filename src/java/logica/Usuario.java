...
public class Usuario implements Serializable {
    ...
    @JoinTable(
            ...
            joinColumns = @JoinColumn(name = "CORREO_SEGUIDOR"),
            inverseJoinColumns = @JoinColumn(name = "CORREO_SEGUIDO")
    )
...
/*
    ...
    */
    ...
    public boolean containSeguido(Usuario us){
        return seguidos.contains(us);
    }
