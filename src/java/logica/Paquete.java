...
public class Paquete implements Serializable {
    ...
    public static Map<String, Paquete> getPaquetes() {
        return paquetes;
    }

    public static void setPaquetes(Map<String, Paquete> paquetes) {
    ...
    public DataPaquete devolverData() {
        ...
        return new DataPaquete(nombrePaquete, descri, alta, validez, descuento, actTuristicaNombres,imagen);
    }
