...
public class Turista extends Usuario {
    ...
    public List<ActividadTuristica> getActsFavoritas() {
        return actsFavoritas;
    }

    public void setActsFavoritas(List<ActividadTuristica> actsFavoritas) {
        this.actsFavoritas = actsFavoritas;
    }
    ...
    @ManyToMany
    @JoinTable(
            name = "TURISTA_ACTIVIDAD_FAVORITA",
            joinColumns = @JoinColumn(name = "turista_correo"),
            inverseJoinColumns = @JoinColumn(name = "actividad_nombre")
    )
    private List<ActividadTuristica> actsFavoritas;
