...
/*
    ...
    public static Map<String, Paquete> getPaqueteNombre() {
        return paqueteNombre;
    }

    public static void setPaqueteNombre(Map<String, Paquete> paqueteNombre) {
        Proveedor.paqueteNombre = paqueteNombre;
    }
