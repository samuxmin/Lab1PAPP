...
<body class="bg-gradient-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <!-- Agregar el área para el mensaje del proveedor -->
                                    <div class="alert alert-warning" role="alert" style="display: none;" id="proveedorMessage">
                                        Este es un mensaje para proveedores. Puedes personalizar el mensaje aquí.
                                    </div>

                                    <form class="user" action="LoginMovil" method="POST" id="login_form">
    ...
    <!-- Script para mostrar el mensaje del proveedor si es necesario -->
    <script>
        // Obtener el mensaje del proveedor desde el servidor (puedes establecerlo en tu servlet)
        var esProveedor = false; // Cambia esto según la lógica de tu aplicación

        // Mostrar el mensaje si es proveedor
        if (esProveedor) {
            document.getElementById("proveedorMessage").style.display = "block";
        }
    </script>
